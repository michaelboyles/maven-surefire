...
public class ForkedProcessEventNotifierTest
{
    ...
    public static class DecoderOperationsTest
    {
        ...
        public void testCreatingReportEntry()
        {
            ...
            decodedReportEntry = EventConsumerThread.newReportEntry( reportEntry.getSourceName(), reportEntry.getSourceText(),
                reportEntry.getName(), reportEntry.getNameText(), reportEntry.getGroup(), reportEntry.getMessage(),
